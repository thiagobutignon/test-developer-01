import { ConnectionNotFoundError, TransactionNotFoundError } from '@/infra/repos/postgres/helpers/errors'
...
import { PgProducts } from '@/infra/repos/postgres/entities'
...
describe('PgConnection', () => {
  ...
  test('should return TransactionNotFoundError on closeTransaction if queryRunner is not found', async () => {
  ...
  test('should return TransactionNotFoundError on commit if queryRunner is not found', async () => {
  ...
  test('should return TransactionNotFoundError on rollback if queryRunner is not found', async () => {
  ...
  test('should get repository from queryRunner', async () => {
    await sut.connect()
    await sut.openTransaction()
    const repository = sut.getRepository(PgProducts)

    expect(getRepositorySpy).toHaveBeenCalledWith(PgProducts)
  ...
  test('should return ConnectionNotFoundError on getRepository if connection is not found', async () => {
    ...
    expect(() => sut.getRepository(PgProducts)).toThrow(new ConnectionNotFoundError())
  })
})
